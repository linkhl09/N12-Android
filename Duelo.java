...
public class Duelo
{
    ...
    public String responderPregunta( String pRespuesta ) throws IOException, BrainsDuelException, InterruptedException
    {
        ...
        else
        {
            ...
            if(resp[1].equals( SI ))
            {
                ...
                jugador.cambiarPreguntasCorona();
            }
    ...
    {
        int categoria = generarNumeroAleatorioEnRango(6);
        String[] categorias = {ARTE, DEPORTES, ENTRETENIMIENTO, HISTORIA, GEOGRAFIA, CIENCIA};
        categoriaAleatoria = categorias[categoria];
    }
}